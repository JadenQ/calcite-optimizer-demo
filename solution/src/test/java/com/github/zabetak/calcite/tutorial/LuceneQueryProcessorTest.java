...
//  @ValueSource(strings = {"SIMPLE", "ADVANCED", "PUSHDOWN"})
  ...
  void testFullScanTpchTablesRuns(LuceneQueryProcessor.Type processor) throws SqlParseException, FileNotFoundException {
  ...
  @ParameterizedTest
  @EnumSource(LuceneQueryProcessor.Type.class)
  void testCountTpchTables(LuceneQueryProcessor.Type processor) throws SqlParseException, FileNotFoundException {
  ...
  @ParameterizedTest
  @EnumSource(LuceneQueryProcessor.Type.class)
  void testFilterOnPKAllColumnsValueTypesMatch(LuceneQueryProcessor.Type processor) throws SqlParseException, FileNotFoundException {
